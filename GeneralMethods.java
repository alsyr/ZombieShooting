...
public class GeneralMethods {
	...
	public static boolean AABBIntersect(int box1X, int box1Y, int box1W, int box1H, int box2X, int box2Y, int box2W, int box2H){
		// box1 to the right
		if( box1X > box2X + box2W )
			return false;
		// box1 to the left
		else if( box1X + box1W < box2X )
			return false;
		// box1 below
		else if( box1Y > box2Y + box2H )
			return false;
		// box1 above
		else if( box1Y + box1H < box2Y )
			return false;
		else
			return true; 
	}
